      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 w-full">
          ...
          <div>
            <Link
              to="/contact"
              className=" !hidden lg:!flex  bg-green-700 text-white px-6 py-2.5 rounded-full font-bold hover:bg-green-800 transition-all shadow-md hover:-translate-y-0.5 whitespace-nowrap"
            >
              Contact Us
            </Link>
          </div>
