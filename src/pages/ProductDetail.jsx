          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              ...
              <a
                ...
                className="flex items-center gap-3 bg-gray-900 hover:bg-green-600 text-white px-8 py-4 rounded-xl font-bold transition-all shadow-lg hover:shadow-green-500/30 w-full sm:w-auto justify-center"
              >
                <Download size={20} />
                Download Brochure (PDF)
              </a>
              ...
              {isSubmitted ? (
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-500 font-medium">
                    ...
                    <strong>{product.name}</strong> shortly.
                  </p>
                </div>
              ) : (
                <>
                  ...
                  <p className="text-gray-500 text-sm mb-8 font-medium">
                    Fill out the form below to get latest pricing and export
                  ...
                  <form onSubmit={handleQuerySubmit} className="space-y-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={product.name}
                        readOnly
                        className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-600 font-bold cursor-not-allowed mt-1"
                      />
                    </div>
                    ...
                    <div>
                      <textarea
                        ...
                        onChange={handleInputChange}
                        rows="4"
                        placeholder="Specific requirements (quantity, destination port, etc.)"
                        className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500/50 resize-none"
                      ></textarea>
                    </div>
