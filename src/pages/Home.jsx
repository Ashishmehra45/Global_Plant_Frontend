...
const Home = () => {
  ...
  const heroSlides = [
    {
      image:
        "https://i.pinimg.com/1200x/5d/f3/81/5df381cd882a465fafe1ac26be26334c.jpg",
    },
    {
      image:
        "https://i.pinimg.com/1200x/42/8c/8e/428c8e06eb83089233a34167ac72a0e8.jpg",
    },
    {
      image:
        "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?q=80&w=2070",
    },
    {
      image:
        "https://i.pinimg.com/1200x/1d/13/40/1d134006841514ae8fe3cf0ac11f66c5.jpg",
    },
  ];
  ...
  const complexStatsData = [
    {
      ...
      desc: "Advised by a trade specialist with 15+ years of international trade and investment advisory experience.",
      color: "from-emerald-50 to-teal-100 text-teal-900 border-teal-200",
    ...
    },
    {
      ...
      desc: "We work directly with farmers and processing units rather than through layers of intermediaries.",
      color: "from-amber-50 to-orange-100 text-orange-900 border-orange-200",
    ...
    },
    {
      ...
      suffix: "°",
      title: "Global Reach",
      desc: "We are structured to trade with any market, not a fixed set of regions.",
      color: "from-blue-50 to-indigo-100 text-indigo-900 border-indigo-200",
    ...
    },
    {
      ...
      suffix: "%",
      title: "Grading Control",
      desc: "Fewer hand-offs mean tighter control over grading and a shorter path from origin to port.",
      color: "from-rose-50 to-pink-100 text-pink-900 border-pink-200",
  ...
  return (
    <div
      ref={mainRef}
      className="w-full bg-white selection:bg-green-500 selection:text-white overflow-hidden"
    >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-32 pb-48 flex flex-col items-center">
          ...
          >
            <motion.span variants={fadeInUp} className="block">
              Bringing India's Agricultural
            </motion.span>
            <motion.span
              variants={fadeInUp}
              className="block text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-emerald-500 to-teal-500 pb-2"
            >
          ...
          >
            An export partner for spices, rice, soy products and oilseeds, built
            on direct relationships with farmers and processors, and advised by
            a trade specialist with 15+ years of international trade experience.
          </motion.p>
          ...
          >
            <Link
              to="/contact"
              className="bg-green-600 text-white px-8 py-4 rounded-full font-bold hover:bg-green-500 transition-all flex items-center justify-center gap-3 shadow-[0_0_30px_-5px_rgba(22,163,74,0.4)] hover:shadow-[0_0_40px_-5px_rgba(22,163,74,0.6)] hover:-translate-y-1 w-full sm:w-auto text-lg"
            >
              Request a Quotation{" "}
              <ArrowRight
                size={20}
            ...
            <Link
              to="/products"
              className="bg-white/10 backdrop-blur-md text-white border border-white/20 px-8 py-4 rounded-full font-bold hover:bg-white hover:text-gray-900 transition-all flex items-center justify-center hover:-translate-y-1 w-full sm:w-auto text-lg"
            >
                ...
                >
                  <div className="relative z-10 flex flex-col h-full items-start">
                    ...
                    <div className="w-full">
                      ...
                      <h3 className="font-bold text-lg mb-2 tracking-tight text-gray-800">
                        {stat.title}
                      </h3>
                      <p className="text-sm leading-relaxed font-medium opacity-75">
                        {stat.desc}
                      </p>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              ...
              {
                title: "Spices",
                img: "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?q=80&w=2070",
                span: "md:col-span-1 md:row-span-1",
              },
              {
                title: "Soy Products & Oilseeds",
                img: "https://i.pinimg.com/736x/7f/20/0b/7f200b9e6e0925a366dc9dbece5b38da.jpg",
                span: "md:col-span-1 md:row-span-1",
              },
            ].map((prod, idx) => (
              <motion.div
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex items-end p-8">
                  <h4 className="text-2xl font-bold text-white font-heading tracking-wide translate-y-2 group-hover:translate-y-0 opacity-90 group-hover:opacity-100 transition-all duration-300">
                    {prod.title}
                  </h4>
                </div>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-10 leading-relaxed">
              ...
              export house connecting India's farms and processing units with
              buyers around the world. We work directly with farmers and
              processing units, keeping the path from origin to destination
              short and transparent.
            </p>
            <Link
              to="/contact"
              className="group bg-gray-900 text-white px-8 py-4 rounded-full font-bold hover:bg-green-600 transition-colors inline-flex items-center gap-3 shadow-lg"
            >
              Get in Touch{" "}
              <ArrowRight
                size={18}
          ...
          <div className="parallax-container relative aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-8 left-8 right-8 sm:right-auto bg-white/90 backdrop-blur-md p-6 rounded-2xl shadow-xl flex items-center gap-5 border border-white/50">
              ...
              <div>
                <h4 className="text-gray-900 font-black text-xl font-heading">
                  100% Certified
                </h4>
